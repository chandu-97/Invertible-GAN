...
def reconstruct(args,generator,dataloader):
    for i, (imgs, labels) in enumerate(dataloader):	
        ...
        save_image(real_imgs.data[:25].reshape(25,3,64,64), "editedimages/{}/{}-original.png".format(args.dataset,i), nrow=5)
        save_image(reconstructed.data[:25].reshape(25,3,64,64), "editedimages/{}/{}-reconstructed.png".format(args.dataset,i), nrow=5,normalize=True)
